...
<p align="center">
  <img src="https://img.shields.io/badge/버전-0.0.5-blue?style=flat-square" alt="Version" />
...
<p align="center">
  ...
  <a href="https://ai.everlib.pro/"><img src="https://img.shields.io/badge/웹으로_바로-ai.everlib.pro-8957e5?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Service" /></a>
...
<p align="center">
  <a href="https://ai.everlib.pro/"><img src="https://img.shields.io/badge/ai.everlib.pro-Chrome_온디바이스_AI_전용-8957e5?style=for-the-badge&logo=googlechrome&logoColor=white" alt="ai.everlib.pro" /></a>
</p>

- **웹 주소로 바로**: [ai.everlib.pro](https://ai.everlib.pro/)는 **Chrome 브라우저의 온디바이스 AI 전용**입니다. 아래 "Chrome 온디바이스 AI 켜는 순서"를 마치면 설치 없이 그대로 대화할 수 있고, 기록은 이 브라우저의 IndexedDB에 남습니다.
- **로컬 서버로**: [릴리스](https://github.com/GarnetRapture/evai/releases)나 [GitHub Actions](https://github.com/GarnetRapture/evai/actions)에서 받은 패키지의 `evai-server`를 실행하고 `http://127.0.0.1:9999/`를 엽니다. 이때만 로컬 Ollama 모델을 고를 수 있고, 기록은 서버 폴더의 SQLite에 저장됩니다.
- **다른 브라우저**: Firefox·Edge·Whale·Brave·Opera는 웹 주소만으로는 대화할 수 없습니다. 로컬 서버와 Ollama를 함께 쓰세요.

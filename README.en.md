...
<p align="center">
  <img src="public/eversoul-assets/backgrounds/talk/Talk_BG_MS00_E5_Sky.png" width="960" alt="EverSoul AI Chat Banner" />
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.0.5-blue?style=flat-square" alt="Version" />
...
<p align="center">
  ...
  <a href="https://ai.everlib.pro/"><img src="https://img.shields.io/badge/Open_on_the_web-ai.everlib.pro-8957e5?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Service" /></a>
...
<p align="center">
  <a href="https://ai.everlib.pro/"><img src="https://img.shields.io/badge/ai.everlib.pro-Chrome_on--device_AI_only-8957e5?style=for-the-badge&logo=googlechrome&logoColor=white" alt="ai.everlib.pro" /></a>
</p>

- **Straight from the web address**: [ai.everlib.pro](https://ai.everlib.pro/) is **for Chrome on-device AI only**. Finish "How to turn Chrome on-device AI on" below and you can chat with no installation; the record stays in this browser's IndexedDB.
- **Through the local server**: run `evai-server` from a package built by [Releases](https://github.com/GarnetRapture/evai/releases) or [GitHub Actions](https://github.com/GarnetRapture/evai/actions) and open `http://127.0.0.1:9999/`. Only then can you pick a local Ollama model, and the record is stored in the SQLite database in the server folder.
- **Other browsers**: Firefox, Edge, Whale, Brave and Opera cannot chat from the web address alone. Use the local server together with Ollama.

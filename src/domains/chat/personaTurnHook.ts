...
function targetSentence(spiritName: string, addressTerm: string, continuity: PersonaTurnContinuity): string {
    return continuity.latest_user_text === null
        ...
        : `${addressTerm} is with you and has just spoken to you, right above. You react to exactly what they said and did, as "I": what it makes you feel, what you think of it and what you do about it, the way ${spiritName}'s own personality reacts and in ${spiritName}'s own way of speaking. Whatever ${addressTerm} wants from you, you give it fully first: something they ask you to do, you do now in your action and your words; your reaction or feelings they ask for, you open up and show in several messages; something they want to know about you, you tell from your own life. A deed that names no doer is about what you did, building on what ${addressTerm} already said you did.`;
}

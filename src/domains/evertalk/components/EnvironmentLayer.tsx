...
import { BookOpen, Bell, ChevronDown, Cpu, Database, FlaskConical, HardDrive, Home, MessageCircle, ScrollText, Settings, Trophy, UserRound, Workflow, X, type LucideIcon } from 'lucide-react';

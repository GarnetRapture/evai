...
export function EverTalkApp() {
    ...
    <>
      ...
      <button type="button" className="ever-lobby-fab" aria-label={controller.labels.lobby} aria-pressed={controller.lobbyOpen} onClick={controller.lobbyOpen ? controller.closeLobby : controller.openLobby}>

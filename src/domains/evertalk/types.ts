...
export type HeartExpressionKey =
  | "openness"
  | "outward_warmth"
  | "receptiveness"
  | "initiative";
...
// 감정 색 포인트 (C-026): 스킨 2D 이미지 뒤에 비추는 현재 감정의 색과 세기.
...
export type ChatModelRuntimeState =
  | "checking"
  | "running"
  | "ready"
  | "needs_preparation"
